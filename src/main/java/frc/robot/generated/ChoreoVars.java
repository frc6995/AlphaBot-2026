...
public final class ChoreoVars {
    ...
    public static final class Poses {
        ...
        public static final Pose2d Testing = new Pose2d(7.393, 2.027, Rotation2d.kZero);
        public static final Pose2d R_Sweep_Flip = new Pose2d(7.316, 1.1, Rotation2d.fromRadians(-2.373));
        public static final Pose2d L_Sweep_Flip = new Pose2d(7.316, 6.946, Rotation2d.fromRadians(2.37));
        public static final Pose2d Testing2 = new Pose2d(8.134, 4.054, Rotation2d.fromRadians(-2.283));
